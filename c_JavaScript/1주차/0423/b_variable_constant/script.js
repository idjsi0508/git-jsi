...
let birthYear2 = prompt('태어난 연도를 입력해주세요.')

// 나이 변수에 올해 연도와 태어난 연도 변수를 사용하여 식을 완성
age = thisYear - birthYear2;

// 해당 나이 결과를 웹 브라우저에서 출력
// '태어난 연도(숫자)'에 태어난 사람의 나이는 '나이(숫자)'세입니다.
document.write( birthYear2 + '년에 태어난 사람의 나이는 ' + age +'세 입니다.')
...
//! 변수의 호이스팅
//? var의 호이스팅
// var= 5; 변수가 선언만 되고 값은 할당 X
console.log(a); // undefind 출력
