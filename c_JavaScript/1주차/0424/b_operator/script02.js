...
false && console.log('and 연산자의 단락평가'); // 뒤에 콘솔 안 나옴
true && console.log('해당 내용은 출력됩니다.');

// 2) OR 연산자(||)
// : 앞선 피연산자의 true가 하나라도 존재하는 경우, 그 뒤의 피연산자는 평가 없이 바로 true를 반환

true || console.log('or 연산자의 단락평가'); // 뒤에 콘솔 안 나옴
