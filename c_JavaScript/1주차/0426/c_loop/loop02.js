...
let arrayLength = array.length; // 밑에 array.length 대신 변수값을 부여함으로 대신 작성 가능
for (let index = 0; index < array.length; index++) { // 배열의 마지막 요소까지 접근
  console.log(index + 1);
  // console.log(array[index]); - 같은 말
}
