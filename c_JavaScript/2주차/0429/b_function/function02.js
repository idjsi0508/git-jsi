...
// 파라미터(매게변수) > 인자(argument): 넘기지 않은 파라미터의 값은 undefined로 지정
// 파라미터(매게변수) < 인자(argument): 초과된 아규먼트의 값은 무시
...
log('hello', 'hi'); // 두 개의 아규먼트(파라미터의 개수보다 많음) - 'hello'만 출력
