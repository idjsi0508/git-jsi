...
numbers.forEach(function (value, index, array) { // array 작성 안 해도 됨
...
// array = [4, 5, 6]; - Error - const 상수에 재할당 불가(전체를 바꿔버리면? 안됨)
// console.log(array); 
...
// : 기존의 배열과 요소의 수가 '일치 하지 않을 수'도 있다.
